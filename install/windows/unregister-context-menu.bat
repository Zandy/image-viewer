@echo off
chcp 65001 >nul
:: Image-Viewer Context Menu Unregistration Script

echo ==========================================
echo Image-Viewer Context Menu Unregistration
echo ==========================================
echo.
...
echo     $path = "Software\Classes\SystemFileAssociations\." + $ext + "\shell\OpenWithImageViewer" >> "%TEMP%\unregister_image_viewer.ps1"
